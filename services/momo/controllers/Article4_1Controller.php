...
/**
 * Handle the article4-1 XML Page
 */

namespace service\controllers;

class Article4_1Controller extends \MiniPaviFwk\controllers\VideotexController
{
    ...
    public function ecran(): string
    {
        ...
        $videotex->ecritUniCode(" page 1/5");
        $videotex->position(4, 1);
        $videotex->couleurTexte("cyan");
        $videotex->ecritUniCode("[màj] la société propose des promotions conséquentes sur ses produits dès       aujourd'hui et pendant les prochaines   semaines.                                                                       retrouvez-les à l'adresse suivante,     https://surfshark.com/fr/deals          ");
