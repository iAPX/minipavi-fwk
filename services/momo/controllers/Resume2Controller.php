...
/**
 * Handle the resume2 XML Page
 */

namespace service\controllers;

class Resume2Controller extends \MiniPaviFwk\controllers\VideotexController
{
    ...
    public function ecran(): string
    {
        ...
        $videotex->couleurTexte("cyan");
        $videotex->ecritUniCode("[màj] l'ipad mini a été mis à jour avec la puce a17 pro, mais elle perd un cœur gpu, n'en ayant que 5. le modèle de basepasse à 128 go, avec wi-fi 6e et        compatibilité apple pencil pro. le prix de l'entrée de gamme est à 609 euros.");
